...
require_once($CFG->dirroot . '/mod/livewebinar/backup/moodle2/restore_livewebinar_stepslib.php');

/**
 * Restore task for the livewebinar activity module
 *
...
class restore_livewebinar_activity_task extends restore_activity_task {
    ...
    protected function define_my_steps() {
        ...
        $this->add_step(new restore_livewebinar_activity_structure_step('livewebinar_structure', 'livewebinar.xml'));
    }
    ...
    public static function define_restore_log_rules() {
        ...
        $rules[] = new restore_log_rule('livewebinar', 'view', 'view.php?id={course_module}', '{livewebinar}');
